            ...
            >
              ...
              <SwiperSlide className="slide1" data-color="#c1e6da">
                <div className="tit_wrap" style={{ marginTop: '60px' }}>
                  <em>발굴된 미래🕰️</em>
                  <strong style={{ color: '#3d3d3d', marginTop: '30px', marginBottom: '20px' }}>다니엘 아샴<br />서울 3024</strong>
              ...
              <SwiperSlide className="slide2" data-color="#e6ffd9">
                <div className="tit_wrap" style={{ marginTop: '60px' }}>
                  <em>아득한 공간🌌</em>
                  <strong style={{ color: '#3d3d3d', marginTop: '30px', marginBottom: '20px' }}>유토피아<br />Nowhere, Now Here</strong>
                  <a href="#" tabIndex={-1}>자세히 보기</a>
                </div>
              </SwiperSlide>
              <SwiperSlide className="slide3" data-color="#ffede0">
                <div className="tit_wrap" style={{ marginTop: '60px' }}>
                  <em>우주의 미스터리🌠</em>
                  <strong style={{ color: '#3d3d3d', marginTop: '30px', marginBottom: '20px' }}>제임스 로젠퀴스트<br />Universe</strong>
                  <a href="#" tabIndex={-1}>자세히 보기</a>
                </div>
              </SwiperSlide>
              <SwiperSlide className="slide4" data-color="#ffe3f8">
                <div className="tit_wrap" style={{ marginTop: '60px' }}>
                  <em>삶에 대한 고찰🤔</em>
                  <strong style={{ color: '#3d3d3d', marginTop: '30px', marginBottom: '20px' }}>정직성<br />Layered Life</strong>
                  <a href="#" tabIndex={-1}>자세히 보기</a>
                </div>
              </SwiperSlide>
            </Swiper>
